...
class TabBarController: UITabBarController {
    ...
    func setupViewControllers() {
        ...
        navController1.tabBarItem = UITabBarItem(title: "Home", image: #imageLiteral(resourceName: "home30sel"), tag: 0)
        ...
        navController2.tabBarItem = UITabBarItem(title: "Blog", image: #imageLiteral(resourceName: "note30copy"), tag: 1)
        ...
        navController3.tabBarItem = UITabBarItem(title: "Me", image: #imageLiteral(resourceName: "ribbon"), tag: 2)
        ...
        navController4.tabBarItem = UITabBarItem(title: "News", image: #imageLiteral(resourceName: "display30copy"), tag: 3)
        ...
        navController5.tabBarItem = UITabBarItem(title: "Web", image: #imageLiteral(resourceName: "cloud30copy"), tag: 4)
