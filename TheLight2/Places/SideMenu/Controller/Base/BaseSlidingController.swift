...
class BaseSlidingController: UIViewController {
    ...
    func didSelectMenuItem(indexPath: IndexPath) {
        ...
        case 0:
            ...
            rightViewController = UINavigationController(rootViewController: PlacesCollectionView(collectionViewLayout: UICollectionViewFlowLayout()))
    ...
    //var rightViewController: UIViewController = UINavigationController(rootViewController: PlacesCollectionView())
